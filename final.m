...
IC = load('init-30.7_v10.mat').IC;
% IC = [525.799375817132,508.618388629238,2231.89022093125,14.8519072951234,37.4830128567897,-45.1033181068021,1880.00312017464];
t0 = 0;
tf = 100;
...
for i = 1: length(IC)
    ...
    % 4: flat top, 1-step
    % 5: flat top, 2-step
    init = IC(i,:);...[r0' v0' m_wet']';

    [t,x] = ode45(@(t,x) odefin(t,x,bf), tSpan, init);
